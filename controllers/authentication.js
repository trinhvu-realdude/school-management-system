            ...
            router.post("/profile", upload.single('profile-pic'), function (req, res) {
                (async function () {
                    ...
                    if (req.file != undefined) {
                        ...
                        await sharp(req.file.path).resize(100, 100).jpeg({quality: 100, progressive: true}).toFile('public/profile_pics/' + filename)
